...
IF EXISTS(SELECT * FROM sys.databases WHERE name  ='NFS3')
DROP DATABASE NFS3;

CREATE DATABASE NFS3;
USE NFS3;
GO
...
CREATE TABLE	Episode(
	EpisodeNumber 	int				NOT NULL PRIMARY KEY,
	Title 			varchar(40) 	NOT NULL,
...
CREATE TABLE	SerieAssociations(
	SerieID			int				NOT NULL FOREIGN KEY REFERENCES Serie(SerieID),
	LooksLike		int				NOT NULL FOREIGN KEY REFERENCES Serie(SerieID),
...
(1215426, 101, 'Frank', '1968-01-25'),
(1215426, 102, 'Madelief', '2001-08-19'),
(5602533, 201, 'Petrus', '1999-06-26'),
(5602533, 202, 'Paulus', '1999-06-26'),
(5285824, 301, 'Fritz', '1968-08-19'),
(5285824, 302, 'Diana', '1988-12-25');
...
INSERT INTO SeriesSeen (EpisodeID, PercentageSeen, UserName) VALUES
(1001, 100, 'Frank'),
(1001, 100, 'Madelief'),
(1001, 100, 'Fritz'),
(1001, 45, 'Diana'),
...
INSERT INTO MoviesSeen (MovieNumber, PercentageSeen, UserName) VALUES
(1010, 5, 'Fritz'),
(1010, 65, 'Madelief'),
(1010, 95, 'Petrus'),
(8001, 100, 'Petrus'),
